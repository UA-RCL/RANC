...
cmd = ('iverilog -o TrueNorthNetwork.o -I ../../sources -Dgrid_dimension_x=%s '
       ...
       '-Dc_s00_axis_tdata_width=%s -s test_TrueNorthNetwork '
       '../../sources/*.v ../tests/test_TrueNorthNetwork.v')
...
def TrueNorthNetwork(input_ports, output_ports, params):
    ...
    return Cosimulation("vvp -m ../iverilog/myhdl.vpi TrueNorthNetwork.o",
