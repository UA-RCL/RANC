...
#
# Streaming.tcl: Tcl script for re-creating project 'Streaming'
#
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/src/blockdesign/streaming/streaming.bd"] \
 [file normalize "${origin_dir}/src/blockdesign/streaming/hdl/streaming_wrapper.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/blockdesign/streaming/streaming.bd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "streaming_wrapper" -objects $obj
