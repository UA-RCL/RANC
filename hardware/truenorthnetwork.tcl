...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xczu9eg-ffvb1156-2-e -quiet -force
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/src/sources/Adder.v"] \
 [file normalize "${origin_dir}/src/sources/Buffer.v"] \
 [file normalize "${origin_dir}/src/sources/CSRAM.v"] \
 [file normalize "${origin_dir}/src/sources/Comp.v"] \
 [file normalize "${origin_dir}/src/sources/Core.v"] \
 [file normalize "${origin_dir}/src/sources/Counter.v"] \
 [file normalize "${origin_dir}/src/sources/EnReg.v"] \
 [file normalize "${origin_dir}/src/sources/ForwardEastWest.v"] \
 [file normalize "${origin_dir}/src/sources/ForwardNorthSouth.v"] \
 [file normalize "${origin_dir}/src/sources/FromLocal.v"] \
 [file normalize "${origin_dir}/src/sources/IntegratorUnit.v"] \
 [file normalize "${origin_dir}/src/sources/LocalIn.v"] \
 [file normalize "${origin_dir}/src/sources/Merge2.v"] \
 [file normalize "${origin_dir}/src/sources/Merge3.v"] \
 [file normalize "${origin_dir}/src/sources/Mux2to1.v"] \
 [file normalize "${origin_dir}/src/sources/NeuronBlock.v"] \
 [file normalize "${origin_dir}/src/sources/OutputBus.v"] \
 [file normalize "${origin_dir}/src/sources/PacketFetch.v"] \
 [file normalize "${origin_dir}/src/sources/PathDecoder2Way.v"] \
 [file normalize "${origin_dir}/src/sources/PathDecoder3Way.v"] \
 [file normalize "${origin_dir}/src/sources/Router.v"] \
 [file normalize "${origin_dir}/src/sources/Scheduler.v"] \
