...
#
# TickGenerator.tcl: Tcl script for re-creating project 'TickGenerator'
#
...
set _xil_proj_name_ "TickGenerator"
...
set script_file "TickGenerator.tcl"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/"] [file normalize "$origin_dir/ip"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/src/design/TickGenerator.v"] \
...
set obj [get_filesets sources_1]
set_property -name "top" -value "TickGenerator" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/src/testbench/TickGenerator_tb.v"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "TickGenerator_tb" -objects $obj
