...
#
# AXI-StreamPacketBuffer.tcl: Tcl script for re-creating project 'AXI-StreamPacketBuffer'
#
...
set _xil_proj_name_ "AXI-StreamPacketBuffer"
...
set script_file "AXI-StreamPacketBuffer.tcl"
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/src/design/AXI-StreamPacketBuffer_M00_AXIS.v"] \
 [file normalize "${origin_dir}/src/design/DoubleBuffer.v"] \
 [file normalize "${origin_dir}/src/design/AXI-StreamPacketBuffer.v"] \
...
set obj [get_filesets sources_1]
set_property -name "top" -value "AXIStreamPacketBuffer" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/src/testbench/AXI-StreamPacketBuffer_tb.v"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "AXIStreamPacketBuffer_tb" -objects $obj
