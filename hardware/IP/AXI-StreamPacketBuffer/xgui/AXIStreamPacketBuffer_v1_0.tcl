...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MAX_NUM_PACKETS" -parent ${Page_0}
...
proc update_PARAM_VALUE.MAX_NUM_PACKETS { PARAM_VALUE.MAX_NUM_PACKETS } {
...
proc validate_PARAM_VALUE.MAX_NUM_PACKETS { PARAM_VALUE.MAX_NUM_PACKETS } {
	# Procedure called to validate MAX_NUM_PACKETS
	return true
}
...
proc update_MODELPARAM_VALUE.MAX_NUM_PACKETS { MODELPARAM_VALUE.MAX_NUM_PACKETS PARAM_VALUE.MAX_NUM_PACKETS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_NUM_PACKETS}] ${MODELPARAM_VALUE.MAX_NUM_PACKETS}
}
