...
truenorthutils. Tests can just determine if the right answer
...
from truenorthutils import save
import subprocess
...
def create_tn_vmm_output(
        ...
        num_axons = 256):
    '''
    Maps the VMM to TrueNorth cores and calls the simulator for the 
    ...
    bash_cmd = '{} -i input.json -o output.txt -c config.json' \
