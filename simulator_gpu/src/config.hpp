...
// RANC-GPU specific limitations, need to limit neuron/axon count to block size (2048)
#define MAX 2048
...
class Config {
    ...
    private:
        ...
        static void validateParameters() {
            validateIntParameterMinMax("num_neurons", MIN, MAX);
            validateIntParameterMinMax("num_axons", MIN, MAX);
            validateIntParameterMinMax("num_cores_x", MIN, MAX);
            validateIntParameterMinMax("num_cores_y", MIN, MAX);
            validateIntParameterMinMax("num_weights", MIN, MAX);
            validateIntParameterMinMax("max_tick_offset", MIN, MAX);
